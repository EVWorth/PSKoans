...
Describe 'Strings' {
    ...
    Context 'Evaluated Strings' {
        ...
        It 'can escape quotation marks' {
            ...
            $String, $AlternateString | Should -Be @("____", "____")
        }
        ...
        It 'can insert special characters with escape sequences' {
            ...
            #>
            $ActualValue = "____" # Don't forget the ` (backtick)!
